...
/* 状態遷移を発生させるイベントの列挙型 */
typedef enum {
    EVENT_POWER_ON = 0,    /* 電源ONイベント Title: イベント: POWER_ON */
    EVENT_START = 1,    /* 開始イベント Title: イベント: START */
    EVENT_STOP = 2,    /* 停止イベント Title: イベント: STOP */
    EVENT_ERROR_DETECTED = 3,    /* エラー検出イベント Title: イベント: ERROR_DETECTED */
